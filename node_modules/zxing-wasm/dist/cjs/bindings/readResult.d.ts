import { type ReadOutputBarcodeFormat } from "./barcodeFormat.js";
...
export interface ReadResult extends Omit<ZXingReadResult, "format" | "eccLevel" | "contentType" | "position"> {
    /**
